...
<SectionWrapper id="product">
    <div class="flex- flex-col gap-10 sm:gap-14 md:gap-24 flex-1 items-center justify-center pb-10 md:pb-14">
      <div class="flex flex-col gap-2">
        ...
        <h3 class="text-4xl sm:text-5xl md:text-6xl mx-auto w-full font-semibold text-center max-w-[1000px]">Features For Everyone</h3>
          ...
          {#each productFeatures as productFeature, index}
            <ProductCard {productFeature} {index}>
                ...
                {:else if index === 1 }
                  ...
                  <span class="text-indigo-400 font-medium">routine</span>
                  and consistency
                {:else}
                  Workouts specific to your
                  <span class="text-indigo-400 font-medium">environment</span>
                  and
